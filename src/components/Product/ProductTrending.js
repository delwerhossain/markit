          ...
          <div className="row">
            {productTrending.slice(0, 6).map((product, index) => {
              return (
                ...
                >
                  <div
                    className="trending__item trending__item-2 d-sm-flex align-items-center transition-3 mb-30 wow fadeInUp"
                    data-wow-delay=".3s"
                  >
                    <div className="trending__thumb mr-25">
                      <div
                        className="trending__thumb-inner fix"
                        onClick={() => dispatch(specificItem(product.id))}
                      >
                        <Link
                    ...
                    <div className="trending__content">
                      ...
                      <h3
                        onClick={() => dispatch(specificItem(product.id))}
                        className="trending__title trending__title-2"
                      >
                        {/* <Link
                href={`/product-details/${encodeURIComponent(
                  product?.title.replace(/\s+/g, "-")
